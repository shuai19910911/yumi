...
Current status: Stage 5.25 has produced a target-journal author-year reference-styled manuscript and a submission-package gate. The manuscript is format-ready for The Plant Genome/G3-style review, but still needs author metadata, final figure inspection, release PID and external gene-name confirmation.
